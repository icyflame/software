...
class Opt(Task):
  ...
  def on_first_run(self):
    ...
    import os
    self.logw('Zeroing heading!')
    os.system('/home/software/cuauv/software/link-stage/auv-zero-heading')
    self.logw('Restarting kalman!')
    os.system('/home/software/cuauv/software/link-stage/trogdor restart kalmand')
    self.logw('Restarting ASLAM!')
    os.system('/home/software/cuauv/software/link-stage/trogdor restart aslamd') 
